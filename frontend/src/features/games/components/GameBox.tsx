import type { GameBoxProps } from '@/types/components';

const GameBox: React.FC<GameBoxProps> = ({ gameName, gameDescription, imageSource }) => {
  return (
    <div id="game-box" className="flex items-start ">
      <div
        id="container"
        className=" bg-[rgba(0,0,0,0.1)] hover:bg-[rgba(0,0,0,0.2)] transition duration-200 border-2 border-[rgba(255,255,255,0.05)] w-full text-white flex items-center"
      >
        <div id="game-image">
          <img
            src={imageSource}
        ...
        <div id="game-info" className="flex justify-between px-5 w-full min-h-30 ">
          <div>
            <div className="flex flex-col py-2">
              <div id="game-name">
                <h3 className="text-[clamp(15px,1.2vw,100px)]">{gameName}</h3>
              </div>

              <div id="game-description">
                <p className="text-[clamp(12px,1vw,100px)] w-[35vw] md:w-[50vw] lg:w-[60vw]">
                  {gameDescription}
                </p>
              </div>
            </div>
