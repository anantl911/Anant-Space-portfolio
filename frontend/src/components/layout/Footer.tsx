const Footer: React.FC = () => {
  return (
    <footer className="z-50">
      <div
        id="footer-container"
        className="min-h-[80px] bg-black w-full pt-12 pb-4 select-none"
      >
        <div>
          ...
          >
            <div id="email-name-inputs" className="flex gap-20">
              <input
                type="text"
                className="bg-black  w-[31vw]  text-white border-b-2 border-[#facd8a] outline-none text-[clamp(13px,1.2vw,16px)] pb-4 px-2"
                placeholder="Name"
              />
              <input
                type="email"
            ...
            <div id="message-input" className="flex gap-20 my-20">
              <textarea
                className="bg-black  w-[68vw]  text-white border-b-2 border-[#facd8a] outline-none text-[clamp(13px,1.2vw,16px)] min-h-15 pb-4 px-2"
            ...
            <div>
              <button
                id="send-contact-btn"
                className="bg-[rgb(250,205,138)] text-black text-[1.4vw] py-1 px-4 hover:cursor-pointer hover:bg-white transition duration-500"
              >
                Send
              </button>
            </div>
